...
<head>
    ...
    <title>Green Leadership Indonesia | Publikasi</title>
    <!--====== Favicon Icon ======-->
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <ul class="navbar-nav mr-auto w-100 justify-content-end">
                        ...
                        <li class="nav-item">
                            <a class="nav-link page-scroll active" href="{{route('viewAllBeritaGLI')}}">Publikasi</a>
                        </li>
                        <li class="nav-item">
            ...
            <div class="container py-5">
                <div class="row g-5">
                    ...
                    <div class="col-lg-4">
                        ...
                        <!-- Recent Post Start -->
                        <div class="mb-5">
                            <h4 class="d-inline-block text-success text-uppercase border-bottom border-5 mb-4">Recent Post</h4>
