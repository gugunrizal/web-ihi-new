...
<head>
  ...
  <title>Civic Education | Tim</title>
  <!--====== Favicon Icon ======-->
...
<body>
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
          <ul class="navbar-nav mr-auto w-100 justify-content-end">
            ...
            <li class="nav-item">
              <a class="nav-link page-scroll active" href="{{route('viewTimCivic')}}">Team</a>
            </li>
            <li class="nav-item">
  ...
  <!-- Team section Start -->
  <section id="team" class="section" style="padding-top: 180px;">
    <div class="container">
      <!-- Start Row -->
      <div class="row">
        <div class="col-lg-12">
          <div class="team-text section-header text-center">
            <div>
              <h2 class="section-title">Team Civic Education</h2>
              <div class="desc-text">
                <p>Organizing Committee Civic Education</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="row justify-content-center">
        ...
        <div class="col-lg-2 col-md-3 col-xs-6">
          <div class="single-team">
            <div class="team-thumb">
              <img src="{{asset('img/civic-edu/tim/oc/1.png')}}" class="img-fluid" alt="" width="20%">
            </div>
            <div class="team-details">
              <div class="team-inner text-center">
                <h5 class="team-title">Muhammad Ichlassul Amal</h5>
                <p>Program Officer</p>
              </div>
            </div>
          </div>
        ...
        <div class="col-lg-2 col-md-3 col-xs-6">
          <div class="single-team">
            <div class="team-thumb">
              <img src="{{asset('img/civic-edu/tim/oc/3.png')}}" class="img-fluid" alt="" width="20%">
            </div>
            <div class="team-details">
              <div class="team-inner text-center">
                <h5 class="team-title">M. Alif Akbar</h5>
        ...
        <div class="col-lg-2 col-md-3 col-xs-6">
          <div class="single-team">
            <div class="team-thumb">
              <img src="{{asset('img/civic-edu/tim/oc/5.png')}}" class="img-fluid" alt="" width="20%">
            </div>
            <div class="team-details">
              <div class="team-inner text-center">
                <h5 class="team-title">Muhammad Ridho Fauzan</h5>
                <p>Organizing Committee</p>
              </div>
            </div>
          </div>
        ...
        <div class="col-lg-2 col-md-3 col-xs-6">
          <div class="single-team">
            <div class="team-thumb">
              <img src="{{asset('img/civic-edu/tim/oc/4.png')}}" class="img-fluid" alt="" width="20%">
            </div>
            <div class="team-details">
              <div class="team-inner text-center">
                <h5 class="team-title">Azi Gunawan Arafiana Putra</h5>
                <p>Organizing Committee</p>
              </div>
            </div>
          </div>
        ...
        <div class="col-lg-2 col-md-3 col-xs-6">
          <div class="single-team">
            <div class="team-thumb">
              <img src="{{asset('img/civic-edu/tim/oc/2.png')}}" class="img-fluid" alt="" width="20%">
            </div>

            <div class="team-details">
              <div class="team-inner text-center">
                <h5 class="team-title">Faza Fatiyurrobbany</h5>
                <p>Organizing Committee</p>
              </div>
            </div>
          </div>
      ...
      <div class="row justify-content-center">
        ...
        <div class="col-lg-2 col-md-3 col-xs-6 mt-4">
          <div class="single-team">
            <div class="team-thumb">
              <img src="{{asset('img/civic-edu/tim/fasil/' . $fs->foto)}}" class="img-fluid" alt="" width="20%">
            </div>
            <div class="team-details">
              <div class="team-inner text-center">
