...
<div class="container py-5">
    <div class="row g-5">
        <div class="col-lg-8">
            ...
            <div class="mb-5">
                <img class="img-fluid w-100 rounded mb-5" src="{{asset('img/' . $d->gambar_berita)}}" alt="">
        ...
        <div class="col-lg-4">
            ...
            <!-- <div class="mb-5">
                ...
                <div class="d-flex flex-column justify-content-start">
                    <a class="h5 bg-light rounded py-2 px-3 mb-2" href="#!"><i
                            class="fa fa-angle-right me-2"></i>Web
                        Design</a>
                    <a class="h5 bg-light rounded py-2 px-3 mb-2" href="#!"><i
                            class="fa fa-angle-right me-2"></i>Web
                        Development</a>
                    <a class="h5 bg-light rounded py-2 px-3 mb-2" href="#!"><i
                        ...
                        Development</a>
                    <a class="h5 bg-light rounded py-2 px-3 mb-2" href="#!"><i
                            class="fa fa-angle-right me-2"></i>Keyword Research</a>
                    <a class="h5 bg-light rounded py-2 px-3 mb-2" href="#!"><i
                            class="fa fa-angle-right me-2"></i>Email Marketing</a>
                </div>
            </div> -->
            <!-- Category End -->
            ...
            <div class="mb-5">
                ...
                <div class="d-flex rounded overflow-hidden mb-3">
                    <img class="img-fluid" src="{{ asset('img/' . $d->gambar_berita) }}"
