                                        ...
                                        <div class="row mb-4 align-items-center">
                                            ...
                                            <div class="col-lg-10">
                                                <div class="input-group form-sm">
                                                    ...
                                                    <input type="text" name="judul" id="judul" class="form-control" id="judul" placeholder="Judul Berita">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-4 align-items-center">
                                            ...
                                            <div class="col-lg-10">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" name="penulis" id="penulis" class="form-control" id="penulis" placeholder="Penulis">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-4 align-items-center">
                                            ...
                                            <div class="col-lg-10">
                                                <div class="input-group">
                                                    ...
                                                    <input type="date" name="tanggal" id="tanggal" class="form-control" placeholder="Tanggal Rilis">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-4 align-items-center">
                                            ...
                                            <div class="col-lg-10">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" name="ringkasan" id="ringkasan" class="form-control" id="ringkasan" placeholder="Ringkasan Berita">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-4 align-items-center">
                                            ...
                                            <div class="col-lg-10">
                                                <select class="form-control" data-select2-selector="status" name="status" id="status">
                                                    <option value="publish" data-bg="bg-success" selected>Publish</option>
                                                    <option value="draft" data-bg="bg-warning">Draft</option>
                                                    <option value="archive" data-bg="bg-danger">Archive</option>
                                                </select>
                                            </div>
                                        </div>
